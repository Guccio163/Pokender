const xd = {
  ...
  cries: {
    latest:
      'https://raw.githubusercontent.com/PokeAPI/cries/main/cries/pokemon/latest/980.ogg',
    legacy: null,
  },
  forms: [
    {name: 'clodsire', url: 'https://pokeapi.co/api/v2/pokemon-form/980/'},
  ],
  game_indices: [],
  height: 18,
  held_items: [],
  id: 980,
  is_default: true,
  location_area_encounters: 'https://pokeapi.co/api/v2/pokemon/980/encounters',
  moves: [
    {
    ...
    {
      move: {name: 'poison-sting', url: 'https://pokeapi.co/api/v2/move/40/'},
      version_group_details: [
        {
          level_learned_at: 1,
          move_learn_method: {
    ...
    {
      move: {name: 'megahorn', url: 'https://pokeapi.co/api/v2/move/224/'},
      version_group_details: [
        {
          level_learned_at: 36,
          move_learn_method: {
    ...
    {
      move: {name: 'poison-tail', url: 'https://pokeapi.co/api/v2/move/342/'},
      version_group_details: [
        {
          level_learned_at: 12,
          move_learn_method: {
    ...
    {
      move: {name: 'toxic-spikes', url: 'https://pokeapi.co/api/v2/move/390/'},
      version_group_details: [
        {
          level_learned_at: 4,
          move_learn_method: {
    ...
    {
      move: {name: 'zen-headbutt', url: 'https://pokeapi.co/api/v2/move/428/'},
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
    ...
    {
      move: {name: 'stealth-rock', url: 'https://pokeapi.co/api/v2/move/446/'},
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
    ...
    {
      move: {name: 'sludge-wave', url: 'https://pokeapi.co/api/v2/move/482/'},
      version_group_details: [
        {
          level_learned_at: 30,
          move_learn_method: {
    ...
    {
      move: {name: 'liquidation', url: 'https://pokeapi.co/api/v2/move/710/'},
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
    ...
    {
      move: {name: 'body-press', url: 'https://pokeapi.co/api/v2/move/776/'},
      version_group_details: [
        {
          level_learned_at: 0,
          move_learn_method: {
  ...
  types: [
    ...
    {slot: 2, type: {name: 'ground', url: 'https://pokeapi.co/api/v2/type/5/'}},
  ],
  weight: 2230,
};